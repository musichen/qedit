...
sets `VITE_BASE_PATH` explicitly. If the site later moves to a repository named
`qedit.github.io` or to a custom domain, set `VITE_BASE_PATH=/` in the workflow;
no source code changes are needed. External URLs and release metadata live in

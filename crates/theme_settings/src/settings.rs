...
use crate::schema::{
    parse_component_radius, status_colors_refinement, syntax_overrides, theme_colors_refinement,
};
...
impl ThemeSettings {
    ...
    fn modify_theme(base_theme: &mut Theme, theme_overrides: &settings::ThemeStyleContent) {
        ...
        let parsed_component_radius = parse_component_radius(&theme_overrides.component_radius);
        let current = &base_theme.styles.component_radius;
        base_theme.styles.component_radius = theme::ThemeComponentRadius {
